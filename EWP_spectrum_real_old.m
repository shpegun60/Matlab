...
deltaT =  0.062791853;%0.0313959265; %%% 0.062791853 %% 0.0104719088;
integralSpaceN = 0:1:10;
...
for i=1:length(integralSpaceN)
    %line([integralSpaceN(i) integralSpaceN(i)], [0 notParityCoeficients(i)],'Marker','s','LineWidth', 2);
    line([integralSpaceN(i) integralSpaceN(i)], [0 notParityCoeficients(i)],'LineWidth', 2);
end
...
for i=1:length(integralSpaceN)
    line([integralSpaceN(i) integralSpaceN(i)], [0 parityCoeficients(i)],'LineWidth', 2);
end
set(gca, 'XTick',0:1:integralSpaceN(length(integralSpaceN)));
